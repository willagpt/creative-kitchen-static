...
- **Next:** Rotate Apify + YouTube API keys (deferred from 3a). Phase 3c, scheduled cron (pg_cron+pg_net or Supabase Scheduled Functions) for daily IG + 2x daily YT fetches with staggered kickoffs and monthly budget guards. Video Analysis Engine Phase 2 (Whisper transcription + OCR). See `docs/handover-2026-04-17-organic-intel-phase-3b.md`.
