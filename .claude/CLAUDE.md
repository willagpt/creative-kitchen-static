...
- **Next:** Monitor cron runs (YT evening 18:30 UTC today, IG 02:15 UTC tomorrow, YT morning 06:30 UTC tomorrow) via the Organic Intel Last-7-days strip + `organic_fetch_log`. Still deferred: rotate Apify + YouTube API keys (both leaked earlier in session). Then VAE Phase 2 OCR per shot subtask (Asana `1214111637586477`, due 8 May).
